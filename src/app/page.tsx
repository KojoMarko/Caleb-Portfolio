...
const DevToIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" {...props}>
        <path d="M120.1 208.3c-3.8-3.3-8.3-5.2-13.3-5.2H72v104h34.8c4.9 0 9.5-1.9 13.3-5.2 3.8-3.3 6-8.1 6-13.2v-67.2c0-5.1-2.2-9.9-6-13.2zM448 80v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48h352c26.5 0 48 21.5 48 48zM232.4 203.2H192v104h40.4c32.4 0 59.6-26.8 59.6-59.2v-5.2c0-29.2-22-54.4-59.6-39.6zM320 203.2h-32v104h32c28.3 0 51.2-23.5 51.2-52s-22.9-52-51.2-52z"/>
    </svg>
);
